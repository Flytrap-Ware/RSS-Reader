...
public interface AuthControllerApi {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "성공",  content = @Content(mediaType = "application/json", schema = @Schema(implementation = SignInResponse.class))),
    })
    ApplicationResponse<SignInResponse> signIn(
    ...
    ApplicationResponse<Void> signOut(HttpSession session);
}
